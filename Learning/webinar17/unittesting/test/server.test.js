...
//On the client side, we use jquery for the test but from nodejs to nodejs testing, we use a lib called request
//request is deprecated, but abhi ke lie use kia h
describe('server', () => {
